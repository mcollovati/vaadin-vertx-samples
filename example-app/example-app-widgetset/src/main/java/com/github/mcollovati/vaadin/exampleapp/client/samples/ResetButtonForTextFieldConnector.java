package com.github.mcollovati.vaadin.exampleapp.client.samples;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.github.mcollovati.vaadin.exampleapp.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
