 ...
 */
public class LocalSessionStoreWrapper implements LocalSessionStore, Handler<Long> {
    ...
    public LocalSessionStoreWrapper(Vertx vertx, String sessionMapName, long reaperInterval) {
        this.vertx = vertx;
