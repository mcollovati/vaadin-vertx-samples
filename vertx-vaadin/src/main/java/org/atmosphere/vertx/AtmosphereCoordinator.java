...
import static org.atmosphere.vertx.AtmosphereUtils.requestfromAtmosphere;
...
public class AtmosphereCoordinator {
    ...
    protected AtmosphereCoordinator route(final HttpServerRequest request, final RoutingContext routingContext) {
        boolean async = false;
        try {
