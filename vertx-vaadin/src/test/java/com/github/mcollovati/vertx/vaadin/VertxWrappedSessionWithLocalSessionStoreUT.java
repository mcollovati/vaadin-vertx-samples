...
public class VertxWrappedSessionWithLocalSessionStoreUT {
    ...
    public void shouldInvokeBindingListener(TestContext context) {
        ...
        VertxWrappedSession session = new VertxWrappedSession(localSessionStore.createSession(10000));
    ...
    public void shouldInvokeBindingListenerWhenSessionExpires(TestContext context) {
        final Async async = context.async(2);
        VertxWrappedSession session = new VertxWrappedSession(localSessionStore.createSession(3000));
        Listener listener1 = new Listener(async);
        session.setAttribute("key", listener1);
    }
